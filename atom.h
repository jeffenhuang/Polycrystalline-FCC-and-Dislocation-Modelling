/* -*- c++ -*- ----------------------------------------------------------
   ...
   * Jianfeng Huang  20-Nov-2015  Added dislocation
------------------------------------------------------------------------- */
...
class Atom : protected Pointers {
 public:
  ...
  int dislocation;              // 0 = no dislocation, 1 = dislocation  
  //tagint *dislocation_p;
  //int *dislocationIndex, *dislocationAtom;
  int ndislocation;
  class Dislocation **dislocations;

  // add dislocation to this simulation system
  void add_dislocation(class Dislocation*);
  void remove_dislocation(class Dislocation*);
  int find_dislocation(const char *);
